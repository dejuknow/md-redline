...
export function Toolbar({
  ...
  return (
    <div className="h-12 border-b border-border bg-surface flex items-center px-4 gap-3 shrink-0">
      ...
      <IconButton variant="active" active={showExplorer} size="md" onClick={onToggleExplorer} title="Toggle file explorer (Cmd+B)">
      ...
      {/* Settings */}
      <IconButton size="md" onClick={onOpenSettings} title="Settings (Cmd+,)">
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
