                  ...
                  {draftTemplates.map((t, i) => (
                    ...
                    >
                      {editingIndex === i ? (
                        ...
                        /* Display row */
                        <div className={`group flex items-center gap-2 rounded-lg px-3 py-2 transition-colors ${
                          dragOverIndex === i && dragIndex !== i ? 'border-t-2 border-primary' : 'border-t-2 border-transparent'
