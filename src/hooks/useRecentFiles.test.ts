...
import { loadFromStorage, saveToStorage } from './useRecentFiles';
...
describe('saveToStorage', () => {
  it('persists files to localStorage as JSON', () => {
    const files = [
      { path: '/b.md', name: 'b.md', openedAt: '2026-01-01T00:00:00.000Z' },
    ];
    saveToStorage(files);
  ...
  it('calls savePreferencesToDisk with the files', () => {
    const files = [
      { path: '/c.md', name: 'c.md', openedAt: '2026-01-01T00:00:00.000Z' },
    ];
    saveToStorage(files);
